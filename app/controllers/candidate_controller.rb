...
class CandidateController < ApplicationController
  def search
    @election_cycles = ['2010', '2012', '2014', '2016', '2018', '2020']  
    @financial_categories = ['candidate-loan', 'contribution-total', 'debts-owed', 'disbursements-total', 'end-cash', 'individual-total', 'pac-total', 'receipts-total', 'refund-total']
